...
import Sidebar from "@/components/Layouts/super-admin/Sidebar";
...
import { getBranches } from '@/store/slices/companySlice';

const SuperAdminLayout = ({children}: { children: React.ReactElement }) => {
                    ...
                    <div className="fixed bottom-6 z-50 ltr:right-6 rtl:left-6">
                        {showTopButton && (
                            <button type="button"
                                    ...
                                    onClick={goToTop}>
                                <svg width="24" height="24" className="h-4 w-4" viewBox="0 0 24 24" fill="none"
