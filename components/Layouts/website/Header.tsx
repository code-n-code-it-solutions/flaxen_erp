        ...
        <header className={themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}>
            <div className="container">
                <div className="shadow-sm">
                    <div className="relative flex w-full justify-between items-center bg-white px-5 py-2.5 dark:bg-black">
                            ...
                            >
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path opacity="0.5" d="M20 12L4 12" stroke="currentColor" strokeWidth="1.5"
                                          strokeLinecap="round"/>
                                    <path d="M20 17L4 17" stroke="currentColor" strokeWidth="1.5"
                                          strokeLinecap="round"/>
                                </svg>
                            </button>
                        </div>
                                            ...
                                            return (
                                                <li key={item.code}>
                                                    ...
                                                    >
                                                        ...
                                                        <span
                                                            className="ltr:ml-3 rtl:mr-3">{t(item.translation_key)}</span>
                                                    </button>
                                                </li>
                                            );
                                        })}
