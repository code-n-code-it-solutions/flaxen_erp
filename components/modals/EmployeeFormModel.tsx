    ...
    return (
        ...
        >
            <Form form={form} layout="vertical">
                ...
                <Form.Item name="loanDate" label="Loan Date" initialValue={moment()} rules={[{ required: true, message: 'Please select a loan date' }]}>
                    <DatePicker defaultValue={moment()} format="YYYY-MM-DD" className="w-full" />
                </Form.Item>
                <Form.Item name="loanAmount" label="Loan Amount" rules={[{ required: true, message: 'Please enter a loan amount' }]}>
                    <Input type="number" placeholder="Enter loan amount" name={''} onChange={function (e: any): void {
                        throw new Error('Function not implemented.');
                    } } isMasked={false} />
                </Form.Item>
                <Form.Item name="deduction" label="Deduction" rules={[{ required: true, message: 'Please select a deduction method' }]}>
                    <Select placeholder="Select a deduction method" onChange={handleDeductionChange}>
