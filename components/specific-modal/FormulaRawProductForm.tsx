...
const FormulaRawProductForm = ({modal, setModal, handleAddRawProduct, modalFormData}: IProps) => {
    ...
    useEffect(() => {
        ...
        if (modal) {
            ...
            setCost(modalFormData ? modalFormData.cost : 0);
                                    ...
                                    <div className="w-full">
                                        ...
                                        <Select
                                            ...
                                            onChange={(e: any) => {
                                                ...
                                                setRawProductUnitPrice(e ? e.unit_price : 0)
                                            }}
                                        />
                                    </div>
                                    <div className="w-full">
