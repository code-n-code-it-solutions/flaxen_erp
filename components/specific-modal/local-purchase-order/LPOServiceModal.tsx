...
const LPOServiceModal = ({modalOpen, setModalOpen, handleSubmit, modalFormData}: IProps) => {
                        ...
                        >
                            <Dialog.Panel as="div"
                                ...
                                <div className="p-5 space-y-5">
                                    ...
                                    <div className="w-full">
                                        <label htmlFor="unit_cost">Per Service Cost</label>
                                        <input
                                            type="number"
                                            name="unit_cost"
                                            id="unit_cost"
                                            ...
                                            disabled={true}
                                            value={quantity}
                                            onChange={e => setUnitCost(e.target.valueAsNumber)}
                                        />
                                    </div>
                                    <div className="w-full">
                                        <label htmlFor="unit_cost">Per Service Cost</label>
...
export default LPOServiceModal;
