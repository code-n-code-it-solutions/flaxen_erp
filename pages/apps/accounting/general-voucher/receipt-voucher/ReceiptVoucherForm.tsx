...
import { storeGeneralReceiptVoucher } from '@/store/slices/generalReceiptVoucherSlice';
...
const ReceiptVoucherForm = () => {
    ...
    const handleSubmit = (e: any) => {
        ...
        dispatch(storeGeneralReceiptVoucher(finalData));
    };

    useEffect(() => {
        setAuthToken(token);
        setContentType('application/json');
        dispatch(generateCode('general_receipt_voucher'));
    ...
    useEffect(() => {
        if (code) {
            setFormData({ ...formData, receipt_voucher_code: code['general_receipt_voucher'] });
        }
    }, [code]);
    ...
    return (
        <form onSubmit={(e) => handleSubmit(e)}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 my-3">
                ...
                />
                <div>
                    <label>Received To Account</label>
                    <TreeSelect
                        showSearch
                        style={{ width: '100%' }}
