...
const EmployeeForm = ({ id }: IFormProps) => {
    ...
    useEffect(() => {
        if (employeeDetail) {
            ...
            setEmployeeBankAccounts(employeeDetail.employee?.bank_accounts.map((account: any) => ({
                id: account.id,
            ...
            setEmployeeDocuments(employeeDetail.employee?.documents.map((document: any) => ({
                id: document.id,
            ...
            dispatch(getDesignationByDepartmentID(employeeDetail.employee?.department_id));
            setFormData({
                ...formData,
                ...
                postal_code: employeeDetail.employee?.postal_code,
                address: employeeDetail.employee?.address,
                date_of_joining: employeeDetail.employee?.date_of_joining,
                passport_number: employeeDetail.employee?.passport_number,
                id_number: employeeDetail.employee?.id_number,
                department_id: employeeDetail.employee?.department_id,
                designation_id: employeeDetail.employee?.designation_id,
                country_id: employeeDetail.employee?.country_id,
                state_id: employeeDetail.employee?.state_id,
                city_id: employeeDetail.employee?.city_id,
