        ...
        <div className="flex flex-col gap-5">
            <PageHeader
                ...
                buttonActions={{
                    ...
                    print: () => router.push('/apps/hrm/configuration/holidays/print/' + selectedRows.map((row) => row.id).join('/')),
            ...
            <div>
                <AgGridComponent
                    ...
                    onRowClicked={(params) => {
                        ...
                        // if (!isActionButton) {
                        router.push(`/apps/hrm/configuration/holidays/view/${params.data.id}`);
                        // }
                    }}
                />
            </div>
            ...
            <HolidayFormModal modalOpen={HolidayModalOpen} setModalOpen={setHolidayModalOpen} holidays={holidayOptions} />
        </div>
    );
};
