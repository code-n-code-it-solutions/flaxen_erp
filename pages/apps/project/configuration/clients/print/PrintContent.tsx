        ...
        <Page size="A4" style={styles.page}>
            ...
            <View style={styles.container}>
                <View style={styles.headerContainer}>
                    <Text style={styles.bold}>Registered At: </Text>
                    <Text style={styles.text}>{(new Date(content.created_at)).toDateString()}</Text>
                    <Text style={styles.bold}>Customer Number: </Text>
                    <Text style={styles.text}>{content.customer_code}</Text>
                </View>
