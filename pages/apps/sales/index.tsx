        ...
        return (
            <div className="">
                <div className="flex flex-col md:flex-row md:justify-between md:items-center w-full mb-5">
                    <h1 className="text-lg">Sales Overview</h1>
                ...
                <div className="mb-6 grid grid-cols-1 gap-6 text-white sm:grid-cols-2 xl:grid-cols-4">
                    <div className="panel bg-gradient-to-r from-cyan-500 to-cyan-400">
                        <div className="flex justify-between">
                            <div className="text-md font-semibold ltr:mr-1 rtl:ml-1">Total Customers</div>
                            <div className="dropdown">
                                ...
                                >
                                    <ul className="text-black dark:text-white-dark">
                                        <li>
                                            <Link href="/apps/sales/configuration/customers">
                        ...
                        <div className="flex justify-between">
                            ...
                            <div className="dropdown">
                                ...
                                >
                                    <ul className="text-black dark:text-white-dark">
                                        <li>
                                            <Link href="/apps/sales/orders/delivery-notes">
                                                <button type="button">Delivery Notes</button>
                                            </Link>
                                        </li>
                                        <li>
                    ...
                    <div className="panel bg-gradient-to-r from-fuchsia-500 to-fuchsia-400">
                        <div className="flex justify-between">
                            <div className="text-md font-semibold ltr:mr-1 rtl:ml-1">Sold FG</div>
                            <div className="dropdown">
                                <Dropdown
                                    offset={[0, 5]}
                                    placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
                                    ...
                                    <ul className="text-black dark:text-white-dark">
                                        <li>
                                            <Link href="/apps/inventory/finish-goods">
                                                <button type="button">Finish Goods List</button>
                                            </Link>
                                        </li>
                                        <li>
                ...
                <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
                    <div className="grid gap-6 xl:grid-flow-row">
                        ...
                        <div className="panel h-full w-full">
                            <div className="mb-5 flex items-center justify-between dark:text-white-light">
                                <h5 className="text-lg font-semibold">Monthly Sales ({new Date().getFullYear()})</h5>
                            </div>
                            <p className="text-lg dark:text-white-light/90">
                                Total Sales <span className="ml-2 text-primary">AED 10,840</span>
                            </p>
                    ...
                    {/*  Recent Transactions  */}
                    <div className="panel">
                        <div className="mb-5 text-lg font-bold">Top 10 Sales</div>
                        <Tab.Group>
