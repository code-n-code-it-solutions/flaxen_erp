...
import { clearCompanySlice, getBranches, setSelectedBranch, setSelectedCompany } from '@/store/slices/companySlice';
        ...
        <div>
            <div
                ...
                <div className="panel m-6 w-full max-w-lg sm:w-[480px]">
                    ...
                    <div
                        className="relative my-7 h-5 text-center before:absolute before:inset-0 before:m-auto before:h-[1px] before:w-full before:bg-[#ebedf2] dark:before:bg-[#253b5c]">
                        <div
                            className="relative z-[1] inline-block bg-white px-2 font-bold text-white-dark dark:bg-black">
                            <span>OR</span>
                        </div>
                    </div>
                    <ul className="mb-5 flex justify-center gap-2 sm:gap-5">
                        <li>
                            ...
                            >
                                <svg className="h-5 w-5 sm:h-6 sm:w-6" viewBox="0 0 256 193" version="1.1"
                        ...
                        <li>
                            <button
                                ...
                                className="btn flex gap-1 bg-white-dark/30 text-black shadow-none hover:bg-white dark:border-[#253b5c] dark:bg-transparent dark:text-white dark:hover:bg-[#1b2e4b] sm:gap-2"
                            >
                                <svg className="h-5 w-5 sm:h-6 sm:w-6" viewBox="0 0 256 250" version="1.1"
                                     xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                                    <g>
                                        <path
                        ...
                        <li>
                            <button
                                ...
                                className="btn flex gap-1 bg-white-dark/30 text-black shadow-none hover:bg-white dark:border-[#253b5c] dark:bg-transparent dark:text-white dark:hover:bg-[#1b2e4b] sm:gap-2"
                            >
                                <svg className="h-5 w-5 sm:h-6 sm:w-6" viewBox="0 0 256 209" version="1.1"
                                     xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                                    <g>
                                        <path
                    ...
                    <p className="text-center">
                        ...
                        <Link href="/auth/signin" className="font-bold text-primary hover:underline ltr:ml-1 rtl:mr-1">
                            Sign In
                        </Link>
                    </p>
                </div>
...
Register.getLayout = (page: any) => <BlankLayout>{page}</BlankLayout>;
