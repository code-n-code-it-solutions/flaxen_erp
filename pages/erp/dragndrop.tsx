        ...
        <div>
            ...
            <div className="dragndrop space-y-8">
                <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 text-primary">
                    ...
                    <a href="https://www.npmjs.com/package/react-sortablejs" target="_blank"
                       className="block hover:underline" rel="noreferrer">
                ...
                <div className="panel">
                    ...
                    <div className="grid grid-cols-1 gap-x-12 sm:grid-cols-2">
                        <div>
                            <ul id="example1">
                                <ReactSortable list={sortable1} setList={setSortable1} animation={200} delay={2}
                                               ghostClass="gu-transit" group="shared">
                                    {sortable1.map((item) => {
                                        return (
                                            <li key={item.id} className="mb-2.5 cursor-grab">
                                                <div
                                                    className="items-md-center flex flex-col rounded-md border border-white-light bg-white px-6 py-3.5 text-center dark:border-dark dark:bg-[#1b2e4b] md:flex-row ltr:md:text-left rtl:md:text-right">
                                                    <div className="ltr:sm:mr-4 rtl:sm:ml-4">
                                                        <img alt="avatar" src={`/assets/images/profile-${item.id}.jpeg`}
                                                             className="mx-auto h-11 w-11 rounded-full"/>
                                                    </div>
                                                    <div
                                                        className="flex flex-1 flex-col items-center justify-between md:flex-row">
                                                        <div className="my-3 font-semibold md:my-0">
                                                            <div
                                                                className="text-base text-dark dark:text-[#bfc9d4]">{item.text}</div>
                        ...
                        <div>
                            <ul id="example2">
                                <ReactSortable list={sortable2} setList={setSortable2} animation={200} delay={2}
                                               ghostClass="gu-transit" group="shared">
                                    {sortable2.map((item) => {
                                        return (
                                            <li key={item.id} className="mb-2.5 cursor-grab">
                    ...
                    <div className="icon-change grid grid-cols-1 gap-x-12 sm:grid-cols-2">
                        <div>
                            <ul id="example3" className="left">
                                <ReactSortable list={iconChange1} setList={setIconChange1} animation={200}
                                               ghostClass="gu-transit" group="icon">
                        ...
                        <div>
                            <ul id="example4" className="right">
                                <ReactSortable list={iconChange2} setList={setIconChange2} animation={200}
                                               ghostClass="gu-transit" group="icon">
                ...
                <div className="panel">
                    ...
                    <div className="grid grid-cols-1 gap-x-12 sm:grid-cols-2">
                        <div>
                            <ul id="example5">
                                <ReactSortable list={handler1} setList={setHandler1} animation={200} handle=".handle"
                                               group="handler" ghostClass="gu-transit">
                                    {handler1.map((item) => {
                                        return (
                                            <li key={item.id} className="mb-2.5 cursor-grab">
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <div className="text-white-dark">
                                                            <span
                                                                className="handle cursor-move rounded bg-[#ebedf2] px-2 ltr:mr-1 rtl:ml-1 dark:bg-black">+</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
                        ...
                        <div>
                            <ul id="example6">
                                <ReactSortable list={handler2} setList={setHandler2} animation={200} handle=".handle"
                                               group="handler" ghostClass="gu-transit">
                                    {handler2.map((item) => {
                                        return (
                                            <li key={item.id} className="mb-2.5 cursor-grab">
                                                <div
                                                    ...
                                                    <div
                                                        className="block flex-1 items-center justify-between text-center sm:flex md:text-left">
                                                        <div className="my-3 font-semibold md:my-0">
                                                            <div
                                                                className="text-base text-dark dark:text-[#bfc9d4]">{item.text}</div>
                                                            <div className="text-xs text-white-dark">{item.name}</div>
                ...
                <div className="panel">
                    ...
                    <div>
                        <div id="example12">
                            <ReactSortable list={newsFeed} setList={setNewsFeed} animation={200}
                                           className="grid grid-cols-1 gap-x-12 sm:grid-cols-2">
                                {newsFeed.map((item) => {
                                    return (
                                        <div className="mb-2.5" key={item.id}>
                                            <div
                                                className="rounded-md border border-white-light bg-white px-6 py-3.5 dark:border-dark dark:bg-[#1b2e4b]">
                                                <div
                                                    className="py-sm-2.5 items-md-center block text-center sm:flex ltr:md:text-left rtl:md:text-right">
                                                    <div className="ltr:sm:mr-4 rtl:sm:ml-4">
                                                        <img alt="avatar"
                                                    ...
                                                    <div
                                                        ...
                                                        <div className="my-3 font-semibold md:my-0">
                                                            <div
                                                                className="text-base text-dark dark:text-[#bfc9d4]">{item.name}</div>
                                                            <div className="text-xs text-white-dark">11 hours ago</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div
                                                    className="mb-4 border-b border-b-[#f1f2f3] py-5 dark:border-b-dark">
                                                ...
                                                <div className="flex-wrap items-center md:flex">
                                                    <div
                                                        className="text-center ltr:md:text-left rtl:md:text-right xl:flex-1">
                                                        <div
                                                            className="flex justify-center -space-x-2 text-white rtl:space-x-reverse md:justify-start">
                                                            <img
                                                    ...
                                                    <div className="text-center ltr:md:text-right rtl:md:text-left">
                                                        <span className="block pt-2 text-xs text-white-dark lg:pt-0">
                                                            <button
                                                                className="mr-1 text-sm font-semibold text-danger dark:text-primary">Vincent,
                                                                Mary
                                                            </button>
                ...
                <div className="dragndrop space-y-8">
                    <div className="panel">
                        ...
                        <div id="example11">
                            <ReactSortable list={gridDrag} setList={setGridDrag} animation={200}
                ...
                <div className="panel">
                    ...
                    <div>
                        <div>
                            <ul id="example7">
                                <ReactSortable list={swap} setList={setSwap} animation={200} swap={true}
                                               swapThreshold={1}
