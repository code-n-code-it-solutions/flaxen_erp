                        ...
                        <div style={{display: 'flex', flexDirection: 'column', gap: '5px'}}>
                            ...
                            <span style={{fontSize: '12px'}}>
                                <strong>Internal Document
                                    No:</strong> {content?.local_purchase_order.internal_document_number}
                            </span>
                        </div>
                    </div>
                    <div
                        ...
                        <div style={{display: 'flex', flexDirection: 'column'}}>
                            ...
                            <span
                                style={{fontSize: '13px'}}><strong>Rep: </strong>{content?.local_purchase_order.vendor_representative.name}
                            </span>
                            <span style={{fontSize: '13px'}}><strong>Rep
                                Ph: </strong>{content?.local_purchase_order.vendor_representative.phone}</span>
                        </div>
                        <div style={{display: 'flex', flexDirection: 'column'}}>
