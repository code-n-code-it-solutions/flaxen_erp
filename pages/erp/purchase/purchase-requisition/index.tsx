...
import Preview from "@/pages/erp/purchase/purchase-requisition/preview";
...
const Index = () => {
    ...
    const {purchaseRequests, loading, success} = useSelector((state: IRootState) => state.purchaseRequisition);
    ...
    const colName = ['id', 'pr_title', 'pr_code', 'description', 'user_id', 'department_id', 'designation_id', 'requisition_date', 'status_id'];
    const header = ['Id', 'Title', 'Code', 'Description', 'Employee', 'Department', 'Designation', 'Requisition Date', 'Status'];
        ...
        >
            <div>
                <div className="mb-5 flex items-center justify-between">
                    <h5 className="text-lg font-semibold dark:text-white-light">All Purchase Requisition</h5>
                    <Button
                        ...
                        link="/purchase/purchase-requisition/create"
                    />
                </div>
                            ...
                            render: (row: any) => (
                                <div className="flex items-center gap-3">
                                    ...
                                    <IconButton
                                        ...
                                        tooltip="View"
                                        link={`/purchase/purchase-requisition/view/${row.id}`}
                                    />
                                    ...
                                    <IconButton
                                        ...
                                        tooltip="Edit"
                                        link={`/purchase/purchase-requisition/edit/${row.id}`}
                                    />
                                    {isNull(row.lpo) && (
                                        <IconButton
                ...
                />
                {/*['id', 'pr_title', 'pr_code', 'description', 'user_id', 'department_id', 'designation_id', 'requisition_date', 'status_id'];*/}
                {/*<div className="mb-5">*/}
                {/*    <Tab.Group>*/}
                ...
                {/*            {({selected}) => (*/}
                {/*                    <button*/}
                {/*                        onClick={() => getRequisitions('Material')}*/}
                ...
                {/*                                stroke="currentColor" strokeWidth="1.5"/>*/}
                {/*                            <path d="M13.5 6L18 6" stroke="currentColor" strokeWidth="1.5"*/}
                {/*                                  strokeLinecap="round"/>*/}
                {/*                            <path d="M6 7L6 5" stroke="currentColor" strokeWidth="1.5"*/}
                {/*                                  strokeLinecap="round"/>*/}
                {/*                            <path d="M9 7L9 5" stroke="currentColor" strokeWidth="1.5"*/}
                {/*                                  strokeLinecap="round"/>*/}
                {/*                            <path d="M13.5 17H18" stroke="currentColor" strokeWidth="1.5"*/}
                {/*                                  strokeLinecap="round"/>*/}
                {/*                            <path d="M6 18L6 16" stroke="currentColor" strokeWidth="1.5"*/}
                {/*                                  strokeLinecap="round"/>*/}
                {/*                            <path d="M9 18L9 16" stroke="currentColor" strokeWidth="1.5"*/}
                {/*                                  strokeLinecap="round"/>*/}
                {/*                        </svg>*/}
                ...
                {/*                {({selected}) => (*/}
                {/*                    <button*/}
                {/*                        onClick={() => getRequisitions('Service')}*/}
                {/*                        className={`${selected ? 'border-b !border-secondary text-secondary !outline-none' : ''}*/}
                {/*                                -mb-[1px] flex items-center border-transparent p-5 py-3 before:inline-block hover:border-b hover:!border-secondary hover:text-secondary`}*/}
                {/*                    >*/}
                {/*                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"*/}
                ...
                {/*                                        </Tippy>*/}
                {/*                                        <Tippy content='Edit'>*/}
                {/*                                            <Link href={`/erp/inventory/products/edit/${row.id}`}>*/}
