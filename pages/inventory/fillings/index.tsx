            ...
            <div className="pt-5">
                <div className="panel">
                    <div className="mb-5 flex items-center justify-between">
                        ...
                        <Link href="/inventory/fillings/create"
                    ...
                    <GenericTable
                        ...
                        columns={[
                            {accessor: 'production_code', title: 'Code', sortable: true},
                            {accessor: 'production_name', title: 'Title', sortable: true},
                            {accessor: 'product_assembly.formula_name', title: 'Formula', sortable: true},
                            {
                                accessor: 'is_active',
                                title: 'Status',
                                render: (row: any) => (
