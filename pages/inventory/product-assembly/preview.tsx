                        ...
                        <tbody>
                            {content?.product_assembly_items.map((item: any, index: any) => (
                                <tr key={index}>
                                    ...
                                    <td style={{ ...myStyle, textAlign: 'center' }}>{(parseFloat(item.cost) * parseFloat(item.quantity)).toFixed(2)}</td>
                                </tr>
                            ))}
                            <tr>
                                <td></td>
                                <th>Total</th>
                                <td></td>
                                <td style={{ ...myStyle, textAlign: 'center' }}>{content?.product_assembly_items.reduce((totalCost: number, item: any) => totalCost + parseFloat(item.cost), 0)}</td>
