...
const Create = () => {
    ...
    useEffect(() => {
        ...
        // const day = currentDate.getDate().toString().padStart(2, '0'); // Ensure day is two digits
        //
        // const newBatchNumber = year + month + day + '001'; // Concatenate year, month, day, and '001'
