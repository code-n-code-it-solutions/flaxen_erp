...
const Index = () => {
    ...
    const {allRawProducts, loading, success} = useSelector((state: IRootState) => state.rawProduct);
    ...
    const colName = ['id', 'item_code', 'title', 'unit', 'valuation_method', 'is_active'];
    const header = ['Id', 'Code', 'Title', 'Unit-Sub', 'In Stock', 'Opening Unit Balance-Total', 'Valuation Method', 'Status'];
            ...
            <div className="pt-5">
                <div className="panel">
                    <div className="mb-5 flex items-center justify-between">
                        <h5 className="text-lg font-semibold dark:text-white-light">All Raw Materials</h5>
                    ...
                    <GenericTable
                        ...
                        columns={[
                            ...
                            {accessor: 'opening_stock', title: 'In Stock (Sub Unit)', sortable: true},
                            {
                            ...
                            {accessor: 'valuation_method', title: 'Valuation Method', sortable: true},
                            {
                                accessor: 'is_active',
                                title: 'Status',
                                render: (row: any) => (
