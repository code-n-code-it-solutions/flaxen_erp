...
const Index = () => {
    ...
    const getRequisitions = (type:string) => {
        ...
        dispatch(getPurchaseRequisitions(type))
    }

    useEffect(() => {
        getRequisitions('Material');
    ...
    const handleGeneratePDF = async (requisition: any) => {
        const pdfContent = ReactDOMServer.renderToStaticMarkup(<Preview content={requisition}/>);
            ...
            <div className="pt-5">
                <div className="panel">
                    <div className="mb-5 flex items-center justify-between">
                        ...
                        <Link href="/purchase/purchase-requisition/create"
