            ...
            <div className="invoice-table">
                <div className="mb-4.5 flex flex-col gap-5 px-5 md:flex-row md:items-center">
                    <div className="flex items-center gap-2">
                        ...
                        <Link href="/template/apps/invoice/add" className="btn btn-primary gap-2">
                            <svg className="h-5 w-5" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"
                        ...
                        columns={[
                            {
                                ...
                                render: ({invoice}) => (
                                    <Link href="/template/apps/invoice/preview">
                                        <div
                                            className="font-semibold text-primary underline hover:no-underline">{`#${invoice}`}</div>
                                    </Link>
                                ),
                            },
                            {
                                    ...
                                    <div className="flex items-center font-semibold">
                                        <div className="w-max rounded-full bg-white-dark/30 p-0.5 ltr:mr-2 rtl:ml-2">
                                            <img className="h-8 w-8 rounded-full object-cover"
                                                 src={`/assets/images/profile-${id}.jpeg`} alt={name}/>
                                        </div>
                                        <div>{name}</div>
                                    </div>
                                ),
                            ...
                            },
                            {
                                ...
                                render: ({amount}) => <div
                                    className="text-right font-semibold">{`$${amount}`}</div>,
                            },
                            // {
                            //     accessor: 'status',
                            //     sortable: true,
                            ...
                            // },
                            {
                                ...
                                render: ({id}) => (
                                    <div className="mx-auto flex w-max items-center gap-4">
                                        <Link href="/template/apps/invoice/edit" className="flex hover:text-info">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg" className="h-4.5 w-4.5">
                                                <path
                                                    opacity="0.5"
                                        ...
                                        <Link href="/template/apps/invoice/preview" className="flex hover:text-primary">
